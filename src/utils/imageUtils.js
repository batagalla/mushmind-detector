 ...
 * @returns {Object} An object containing validation result and error message if any
 */
 ...
 * @returns {Promise<Blob>} Promise that resolves to a Blob containing the resized image
 */
